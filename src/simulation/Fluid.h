...
class Fluid {
  ...
  public:
     ...
     */
    Fluid(int id, T density, T viscosity, T concentration, T molecularSize, T diffusionCoefficient, T saturation);
     ...
     */
    Fluid(int id, T density, T viscosity, T concentration, T molecularSize, T diffusionCoefficient, T saturation, std::string name);
