...
class Fluid {
  private:
    ...
    T saturation;                       ///< Saturation value to translate the concentration in an actual concentration value in mol/m^3
  ...
  public:
     ...
     */
    Fluid(int id, T density, T viscosity, T concentration, T molecularSize, T diffusionCoefficient, T saturation, int mixtureId);
     ...
     */
    Fluid(int id, T density, T viscosity, T concentration, T molecularSize, T diffusionCoefficient, T saturation, int mixtureId, std::string name);
